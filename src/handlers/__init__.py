...
from .user_routers.user_about import router as about_router
from .user_routers.user_support import router as support_router


routers = [admin_router, main_router, profile_router, p2p_router, deal_router, language_router, about_router, support_router]